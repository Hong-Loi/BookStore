										...
										<li class="menu-item-has-children current-menu-item">
											...
											<ul class="sub-menu">
												<li class="menu-item-has-children current-menu-item">
													...
													<ul class="sub-menu">
														<li class="current-menu-item"><a href="products.blade.php">Products</a></li>
...
</html><?php /**PATH C:\wamp\www\library\resources\views/template/products.blade.php ENDPATH**/ ?>